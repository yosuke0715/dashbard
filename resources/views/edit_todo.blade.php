...
@section('content')
<!-- Page Heading -->
<form action="{{ asset('/todo_update') }}" method="post" class="row d-flex">
@csrf
    <input type="hidden" name="id" value="{{ $item->id }}">
    <div class="form-floating mb-3 col-9">
        <input type="text" value="{{ $item->content }}" class="form-control" id="floatingInput" placeholder="オリジナルサイトを作成する" name="content">
